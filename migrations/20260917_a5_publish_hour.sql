-- Apply after 20260917_a5_publish_days.sql.
-- Per-story publish time. clients.publish_days now stores
-- [{"day": 0-6, "time": "HH:MM"}, ...] x4 instead of a plain day array —
-- safe to redefine since no real client has a non-null value yet.
begin;
